<<<<<<< HEAD:RPi/robotbartender/picovoiceBartender/PicovoiceBartender.py
import os
import sys
import struct
import wave
...
class PicovoiceBartender(Thread):
    ...
    def show_audio_devices(cls):
        ...
        for i in range(len(devices)):
>>>>>>> c00c187364ad38fa70337fe2e5e05ca6fcb3dda2:RPi/robotbartender/picovoicebartender/picovoicebartender.py
